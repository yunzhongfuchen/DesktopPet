...
void localMusic::localMusicLayout(void)
{
    ...
    displayLabel[0]->setText(__QString("本地音乐"));
...
void localMusic::songInfoLayout(void)
{
    ...
    matchMusic->setText(__QString("清空列表"));
    ...
    tableList = __QString(",音乐标题,歌手,专辑,时长,大小").split(",");
...
void localMusic::table_customContextMenuRequest(const QPoint &pos)
{
    ...
    QAction *play = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_play.png"), __QString("播放"));
    QAction *nextPlay = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_playnext.png"), __QString("下一首播放"));
    menu->addSeparator();
    QAction *Collecttolist = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_collectlist.png"), __QString("收藏到歌单"));
    QAction *sharemusic = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_share.png"), __QString("分享"));
    QAction *coppy = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_coppy.png"), __QString("复制链接"));
    QAction *uploadcloud = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_cloudmusic.png"), __QString("上传到我的音乐云盘"));
    QAction *opendir = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_folder.png"), __QString("打开文件所在目录"));
    menu->addSeparator();
    QAction *deletefromlist = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_delete.png"), __QString("从列表中删除(Delete)"));
    QAction *deletefromlocal = menu->addAction(QIcon(":/images/stackWidget/localMusic/btn_delete.png"), __QString("从本地磁盘删除"));

    QMenu *collectChild = new QMenu(this);
    Collecttolist->setMenu(collectChild);

    QAction *creatnewSheet = collectChild->addAction(QIcon(":/images/stackWidget/localMusic/btn_add.png"), __QString("创建新歌单"));
    QAction *myfavor = collectChild->addAction(QIcon(":/images/stackWidget/localMusic/btn_add.png"), __QString("我喜欢的音乐"));
